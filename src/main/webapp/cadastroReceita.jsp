<%-- src/main/webapp/cadastroReceita.jsp --%>
...
<div class="container">
    <div class="form-card">
        ...
        <form action="<%= request.getContextPath() %>/receitas" method="post"> <%-- Action para o ReceitaServlet --%>
            ...
            <div class="form-group">
                ...
                <input type="number" id="valor" name="valor" step="0.01" min="0.01" required placeholder="Ex: 5000.00">
            </div>
            <div class="form-group">
