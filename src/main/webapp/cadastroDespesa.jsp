<%-- src/main/webapp/cadastroDespesa.jsp --%>
...
<head>
    ...
    <title>Din+ - Cadastrar Despesa</title>
...
<div class="container">
    <div class="form-card">
        ...
        <% // Mensagem de sucesso após redirecionamento
            ...
            if ("true".equals(sucessoParam)) { %>
        <p class="success-message">Despesa cadastrada com sucesso!</p>
        <% } %>


        <form action="<%= request.getContextPath() %>/despesas" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" id="valor" name="valor" step="0.01" min="0.01" required placeholder="Ex: 99.99">
            </div>
            <div class="form-group">
